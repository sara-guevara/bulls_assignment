...
3. Apply the model to each player's statistics and create a value for each player to predict their ability score points and help a team win.

4. Compare the player value metric to each athlete's salary and use the combination to choose the starting five recommended players for the 2019-2020 NBA season for the Chicago Bulls.  
